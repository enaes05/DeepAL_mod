...
from handlers import MNIST_Handler, SVHN_Handler, CIFAR10_Handler, HeadAndNeck_Handler
from data import get_MNIST, get_FashionMNIST, get_SVHN, get_CIFAR10, get_HeadAndNeck
from nets import Net, MNIST_Net, SVHN_Net, CIFAR10_Net, HeadAndNeck_Net
...
def get_handler(name):
    ...
    elif name == 'HeadAndNeck':
        return HeadAndNeck_Handler
...
def get_dataset(name):
    if name == 'MNIST':
        ...
        return get_HeadAndNeck(get_handler(name))
    else:
...
def get_net(name, device):
    if name == 'MNIST':
        ...
        return Net(HeadAndNeck_Net, params[name], device)
    else:
        raise NotImplementedError
